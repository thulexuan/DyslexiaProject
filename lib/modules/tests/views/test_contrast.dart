...
import 'common_widgets/testElementItem.dart';
import 'common_widgets/test_contrast_item.dart';

class TestContrastPage extends StatefulWidget {

  String letter;
  int quesNum;

  TestContrastPage({super.key,
    required this.letter,
    required this.quesNum
  });

  @override
  State<TestContrastPage> createState() => _TestContrastPageState();
}

class _TestContrastPageState extends State<TestContrastPage> {
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: TestContrastItem(
                ...
                fontFamily: 'Arial',
                backgroundColor: Colors.white, opacity: 0.25, textColor: Colors.black,
              ),
            ),
          ),
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: TestContrastItem(
                ...
                fontFamily: 'Arial',
                backgroundColor: Colors.white, opacity: 0.5, textColor: Colors.black,
              ),
            ),
          ),
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: TestContrastItem(
                ...
                fontFamily: 'Arial',
                backgroundColor: Colors.white, opacity: 0.75, textColor: Colors.black,
              ),
            ),
          ),
        ],
